...
export class UserService {
  ...
  async updateUser(
    userId: string,
    data: { name?: string; email?: string; username?: string | null; codeforcesHandle?: string | null; codeforcesLastSync?: Date | null; leetcodeUsername?: string | null; leetcodeLastSync?: Date | null; githubUsername?: string | null; githubToken?: string | null; githubLastSync?: Date | null }
  ) {
